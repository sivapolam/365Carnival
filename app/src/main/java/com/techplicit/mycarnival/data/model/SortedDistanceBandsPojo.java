 ...
 */
public class SortedDistanceBandsPojo implements Comparable<SortedDistanceBandsPojo>{
    ...
    public SortedDistanceBandsPojo(JSONObject jsonObject) {
        if (jsonObject!=null){
    ...
    @Override
    public int compareTo(SortedDistanceBandsPojo another) {
