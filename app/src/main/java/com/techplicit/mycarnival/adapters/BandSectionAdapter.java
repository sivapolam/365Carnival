 ...
 */
public class BandSectionAdapter extends BaseAdapter implements Constants {
    ...
    public BandSectionAdapter(Context context, ArrayList<BandSectionPojo> carnivalsPojoArrayList) {
        ...
        holder.iv_band_fav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Utils.isBandSecFav(bandsPojoArrayList.get(position))) {
                    ...
                    Utils.storeBandSection(bandsPojoArrayList.get(position));
                    holder.iv_band_fav.setImageResource(R.drawable.fav);
                }
            }
        });
