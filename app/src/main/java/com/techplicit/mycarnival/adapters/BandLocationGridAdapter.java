 ...
 */
public class BandLocationGridAdapter extends BaseAdapter implements Constants {

    private Context context;

    LayoutInflater inflater;
    private ArrayList<BandLocationPojo> bandsPojoArrayList;
    ImageLoader imageLoader;
    private BandLocationPojo bandsPojo;

    public BandLocationGridAdapter(Context context, ArrayList<BandLocationPojo> carnivalsPojoArrayList) {
