 ...
 */
public class FetesAdapter extends BaseAdapter implements Constants, IResponseInterface {
    ...
    public FetesAdapter(Context context, ArrayList<FeteDetailModel> carnivalsPojoArrayList) {
        ...
        holder.iv_band_fav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Utils.isBandFeteDetailFav(bandsPojoArrayList.get(position))) {
                    ...
                    Utils.storeBandFeteDetail(bandsPojoArrayList.get(position));
                    holder.iv_band_fav.setImageResource(R.drawable.fav);
                }
            }
        });
