 ...
 */
public class BandsFavAdapter extends BaseAdapter implements Constants, IResponseInterface {
    ...
    public BandsFavAdapter(Context context, BandsMyFavourites bandsMyFavourites, ArrayList<BandsPojo> carnivalsPojoArrayList) {
        this.context = context;
        this.bandsPojoArrayList = carnivalsPojoArrayList;
        noDataInterface = (NoDataInterface) bandsMyFavourites;
